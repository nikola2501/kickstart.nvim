...
-- Ntree
vim.keymap.set('n', '<C-n>', '<cmd>Ntree<cr>', { desc = 'Toggle Ntree' })
...
vim.keymap.set('n', '<leader>zd', '<cmd>FzfLua lsp_document_diagnostics<cr>', { desc = 'fzf lsp doc diagnostics' })
vim.keymap.set('n', '<leader>zz', '<cmd>FzfLua lsp_workspace_diagnostics<cr>', { desc = 'fzf lsp workspace diagnostics' })
vim.keymap.set('n', '<leader>zt', '<cmd>FzfLua lsp_code_actions<cr>', { desc = 'fzf lsp code actions' })

-- Clear highlights on search when pressing <Esc> in normal mode
--  See `:help hlsearch`
vim.keymap.set('n', '<Esc>', '<cmd>nohlsearch<CR>')

-- LSP hover with explicit border (custom keymap for testing)
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        zls = {
          cmd = { '/Users/nikola.milenkovic/zig/zls' },
        },
  ...
  -- Custom indent-blankline configuration with nice characters
  -- {
  --   'lukas-reineke/indent-blankline.nvim',
  --   main = 'ibl',
  --   opts = {
  --     indent = {
  --       -- char = '┊', -- Možete promeniti: '│', '┊', '┆', '¦', '|', '⎸'
  --       -- char = '▏',  -- Tanji stil
  --       -- char = '▎',  -- Srednji stil
  --     },
  --     scope = {
  ...
  --       show_start = false,
  --       show_end = false,
  --       -- char = '┊', -- Karakter za trenutni scope (aktivni blok koda)
  --     },
  --     exclude = {
  --       filetypes = {
  --         'help',
